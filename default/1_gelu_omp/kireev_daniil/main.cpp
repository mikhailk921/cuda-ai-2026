...
inline constexpr size_t ARRAY_SIZE = 134217728;
...
int main() {
    ...
    std::cout << "Generating data start" << std::endl;
    ...
    std::cout << "Ref time is " << std::chrono::duration_cast<std::chrono::milliseconds>(endRef - beginRef).count() << "ms" << std::endl;

    std::cout << "Warm up start" << std::endl;
    GeluOMP(inputData);
    std::cout << "Warmi up end" << std::endl;

    std::cout << "Payload start" << std::endl;
    std::chrono::steady_clock::time_point begin = std::chrono::steady_clock::now();
    auto result = GeluOMP(inputData);
    std::chrono::steady_clock::time_point end = std::chrono::steady_clock::now();
    std::cout << "Payload end" << std::endl;
    
    std::cout << "Payload time is " << std::chrono::duration_cast<std::chrono::milliseconds>(end - begin).count() << "ms" << std::endl;

    std::cout << "Accuracy start" << std::endl;
    float error = 0.0f;
    for (size_t n = 0; n < ARRAY_SIZE; ++n) {
    ...
    std::cout << "Accuracy end" << std::endl;
